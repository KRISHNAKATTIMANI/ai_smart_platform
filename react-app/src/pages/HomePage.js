          ...
          {features.map((feature) => {
            ...
            return (
              <div
                ...
                className="bg-white rounded-xl shadow-md p-6 cursor-pointer transform transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:scale-105 border-2 border-transparent hover:border-primary"
              >
